...
public class MenuSalesPanel extends JPanel {

	private JPanel btnSell;
	...
	public MenuSalesPanel() {
		...
		add(btnSell);
		btnSell.setLayout(new BorderLayout(0, 0));
		
		lblSell = new JLabel("Sell");
		lblSell.setFont(new Font("Roboto Medium", Font.PLAIN, 25));
		lblSell.setHorizontalAlignment(SwingConstants.CENTER);
		btnSell.add(lblSell, BorderLayout.CENTER);
		
		separator = new JSeparator();
		btnSell.add(separator, BorderLayout.EAST);
